...
urlpatterns = [
    ...
    path('category/<int:category_id>/<int:quiz_id>/',
         views.add_to_category, name='add_to_category'),
    path('categories/<int:quiz_id>/',
    ...
    path('<int:quiz_id>/<int:question_id>/answer/',
         views.answer, name='answer'),
    path('<int:quiz_id>/results/add/',
         views.add_results, name='add_achievement'),
